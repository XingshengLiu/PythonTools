...
Type = 'Grade'
Path = r'H:\大数据中台项目\标签测试报告\年级标签\系统管理部数据\0912_v2\剔除学龄前\系统管理部年级标签1w数据_验证集去除学龄前年级加一mg_9_12大数据更新结果' + '.xlsx'
Pathresult = r'H:\大数据中台项目\标签测试报告\年级标签\系统管理部数据\0912_v2\剔除学龄前\系统管理部年级标签1w数据_验证集去除学龄前年级加一mg_9_12大数据更新结果' + '_0912测试结果.xlsx'
